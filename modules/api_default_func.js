...
const apiDefaultFunc = {
  ...
  loggingParams : (req, res, next) => {
    try {
      ...
      //Logging parameter
      console.log(`======${req.logiD} NEWEST ${req.api}:`, JSON.stringify(params))

      //Logging header
      console.log(`======${req.logiD} NEWEST HEADERS:`, JSON.stringify(req.headers))

      //IP
      console.log(`======${req.logiD} NEWEST REQUEST IP:`, req.IP)
